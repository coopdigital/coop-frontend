...
import { ReactToHtmlHighlighter }  from '../../../.storybook/blocks/ReactToHtmlHighlighter';
...
## test ReactCodeHighlighter in docs
export const myTestComponent = <ComponentExample heading="This is a heading" />;

<ReactToHtmlHighlighter>
  <ComponentExample heading="This is a heading" />
</ReactToHtmlHighlighter>
