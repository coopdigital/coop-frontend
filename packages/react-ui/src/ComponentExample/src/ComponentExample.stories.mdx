...
import CustomDocumentationComponent from "../../../.storybook/blocks/CustomSource";
// import { Canvas } from '../../../.storybook/blocks/Canvas';
import { SourcePlus } from '../../../.storybook/blocks/SourcePlus';

import ReactCodeHighlighter  from '../../../.storybook/blocks/ReactCodeHighlighter';
...
export const testComp = <ComponentExample heading="new test heading" content="This is an example Component you can copy from to create your own components"/>
export const staticMarkup = ReactDOMServer.renderToStaticMarkup(testComp);
console.log(staticMarkup);
export const prettyHtml = prettier.format(staticMarkup, { parser: "html", plugins: [parserHtml]});
...
## react syntax highlighter test
export const myVariable = <ComponentExample heading="This is a heading" />;

<SyntaxHighlighter language="xml" styles={dark} >
  {prettyHtml}
</SyntaxHighlighter>
